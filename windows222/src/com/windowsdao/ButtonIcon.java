...
public class ButtonIcon extends JPanel  {
		...
		jb1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (e.getButton() == MouseEvent.BUTTON1) {
					...
					// 点击中间
					JOptionPane.showMessageDialog(ButtonIcon.this, "丫头，爸爸爱你呦");
	...
	void Tool1( String nemeaaaa ) {
		jmt1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (resR) {
					JOptionPane.showMessageDialog(ButtonIcon.this, "删除成功");
				} else {
					JOptionPane.showMessageDialog(ButtonIcon.this, "删除失败");
				}
		...
		jmt2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// 重命名:递归：方法传入true
				newNameNew = JOptionPane.showInputDialog(ButtonIcon.this, "请输入新名字", jb1.getText());
				if (newNameNew != null) {
...
//			}
	...
	boolean findnames(boolean name, JButton jb1) {
		if (!name) {
			newNameNew = JOptionPane.showInputDialog(ButtonIcon.this, "名字不可重复，请重新输入", jb1.getText());
